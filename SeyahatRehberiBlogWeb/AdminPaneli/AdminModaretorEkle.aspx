<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPaneli/AdminPanel.Master" AutoEventWireup="true" CodeBehind="AdminModaretorEkle.aspx.cs" Inherits="SeyahatRehberiBlogWeb.AdminPaneli.AdminModaretorEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="FormTasiyici">
        ...
        <div class="FormIcerik">
            ...
            <div class="satir">
                <asp:Button ID="lbtn_ekle" runat="server" CssClass="FormButton" Text="Admin/Moderatör Ekle" OnClick="lbtn_ekle_Click" />
            </div>
        </div>
    </div>
