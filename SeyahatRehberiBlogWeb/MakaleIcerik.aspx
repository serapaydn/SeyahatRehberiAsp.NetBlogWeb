<%@ Page Title="" Language="C#" MasterPageFile="~/Arayuz.Master" AutoEventWireup="true" CodeBehind="MakaleIcerik.aspx.cs" Inherits="SeyahatRehberiBlogWeb.Makaleİcerik" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="makale">
        ...
        <div class="bilgi">
            ...
            <span style="font-weight: bold; font-size: 25pt; color: dimgray; padding-left: 5px; padding-right: 5px;">.</span>
            <label>Konum:</label>
            <asp:Literal ID="ltrl_Konum" runat="server"></asp:Literal>
        </div>
    ...
    <asp:Repeater ID="rp_yorumlar" runat="server">
        <ItemTemplate>
            <div class="Yorum">
                ...
                <div class="Bilgiler">
                    Uye: <%#Eval("UyeIsim") %> | Tarih: <%#Eval("TarihveSaat") %>
                </div>
            </div>
        </ItemTemplate>
    </asp:Repeater>
