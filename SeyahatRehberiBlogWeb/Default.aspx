<%@ Page Title="" Language="C#" MasterPageFile="~/Arayuz.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SeyahatRehberiBlogWeb.Default" %>
        ...
        <ItemTemplate>
            <div class="makale">
                ...
                <div class="bilgi">
                    ...
                    <label>Tarih:</label>
                    <%# Eval("TarihStr") %> <span style="font-weight: bold; font-size: 25pt; color: dimgray; padding-left: 5px; padding-right: 5px;">.</span>
                    <label>Konum:</label>
                    <%# Eval("Konum") %>
                </div>
                <div class="ozet">
